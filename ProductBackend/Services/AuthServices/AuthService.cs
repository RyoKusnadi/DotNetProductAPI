...
namespace ProductBackend.Services.AuthServices
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<ServiceResponseDto<int>> Register(Users user, string password)
        {
        ...
        public async Task<ServiceResponseDto<string>> GetUser()
        {
            var response = new ServiceResponseDto<string>();
            response.Success = true;
            response.Message = "Masuk";
            response.Data = _context.Users.FirstOrDefaultAsync().Result.Email;
            return response;
        }
